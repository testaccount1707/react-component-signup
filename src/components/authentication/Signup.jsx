              ...
              <div className="flex gap-4 items-center align-top">
                ...
                <div className="mt-2">
                  <input
                    {...register("tc")}
                    name="tc"
                    className="flex rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                    type="checkbox"
                    placeholder="Tc"
                  ></input>
                </div>
